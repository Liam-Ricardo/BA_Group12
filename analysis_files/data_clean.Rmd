...
^*It's just I like to keep a copy of all the versions of data. So, I'm taking a copy of the raw_data into a new variable called 'cleaned_data' And I will use that moving forward. If you don't prefer that way DO NOT run this cell.*^
...
Surprisingly, the dataset does not contain any null values. We do not have to impute the null values.
