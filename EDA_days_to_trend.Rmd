...
path = "D:/Netherlands/TU DELFT/Q3 2024/Business Analytics/R/trending_yt_videos_113_countries.csv"
```
...
data_clean <- data_clean %>%
  mutate(
    publish_date = as.Date(publish_date, format = "%Y-%m-%d")  # Adjust format to match your data
  )
  mutate(publish_day = weekdays(publish_date))
