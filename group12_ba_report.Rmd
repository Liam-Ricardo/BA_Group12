...
To further explore regional performance, we visualize how daily movement relates to view counts within the top-ranking countries.

```{r plotting top 10% countries in relation to daily_rank}
...
There are clear outliers present within each country, while the majority of videos are densely clustered around lower view counts and moderate daily movement. Additionally, the spread of points varies across countries, indicating differing engagement patterns and distribution of video performance.
...
```{r}
# Update this variable with the your own filepath 
#data_filepath <- "./dataset/trending_yt_videos_113_countries_model_training.csv"
...
final_df <- yt_df %>% select(all_of(selected_cols))
...
split <- initial_split(final_df, prop = 0.9, strata = target)
