...
For an more detailed overview of analysis per variable and corresponding boxplot, see the table below.
...
: Table overview of insights from boxplots categorical variables
