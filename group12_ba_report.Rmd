...
We have completed our EDA in the previous section and now we have understood the dataset completely. We can now create (or update the existing columns) features that will be fed as inputs to the model. There can be various methods of feature engineering like selecting the important columns or creating new columns by merging (or using any other logic) the existing columns.
